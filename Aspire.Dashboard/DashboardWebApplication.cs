...
public sealed class DashboardWebApplication : IAsyncDisposable
{
        ...
        WebApplicationOptions? options = null)
    {
        ...
        //dashboardOptions.Otlp.GrpcEndpointUrl = "https://localhost:4317"; // Default OTLP gRPC endpoint URL
        //dashboardOptions.Otlp.HttpEndpointUrl = "http://localhost:4318";
        dashboardOptions.Frontend.AuthMode = FrontendAuthMode.Unsecured;
        dashboardOptions.Frontend.EndpointUrls = "https://localhost:5000";
